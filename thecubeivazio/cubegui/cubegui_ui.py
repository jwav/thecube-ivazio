...
"}")
        ...
        self.lineAdminRfidResetter.setReadOnly(True)
        ...
        self.comboAdminCubeboxToOrder = QtWidgets.QComboBox(self.tabAdmin)
        self.comboAdminCubeboxToOrder.setObjectName("comboAdminCubeboxToOrder")
        self.gridLayout_2.addWidget(self.comboAdminCubeboxToOrder, 1, 0, 1, 1)
        self.btnAdminOrderCubeboxReset = QtWidgets.QPushButton(self.tabAdmin)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/icon_zero.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnAdminOrderCubeboxReset.setIcon(icon1)
        self.btnAdminOrderCubeboxReset.setObjectName("btnAdminOrderCubeboxReset")
        self.gridLayout_2.addWidget(self.btnAdminOrderCubeboxReset, 1, 1, 1, 1)
        self.btnAdminOrderCubeboxReboot = QtWidgets.QPushButton(self.tabAdmin)
        icon = QtGui.QIcon.fromTheme("reload")
        self.btnAdminOrderCubeboxReboot.setIcon(icon)
        self.btnAdminOrderCubeboxReboot.setObjectName("btnAdminOrderCubeboxReboot")
        self.gridLayout_2.addWidget(self.btnAdminOrderCubeboxReboot, 1, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.btnAdminOrderCubeboxReset.setText(_translate("Form", "Ordonner reset CubeBox"))
        self.btnAdminOrderCubeboxReboot.setText(_translate("Form", "Redémarrer CubeBox"))
