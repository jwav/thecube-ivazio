...
"}")
        ...
        self.tableTeamsTeamInfo = QtWidgets.QTableWidget(self.tabFinishedGames)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(30)
        sizePolicy.setHeightForWidth(self.tableTeamsTeamInfo.sizePolicy().hasHeightForWidth())
        self.tableTeamsTeamInfo.setSizePolicy(sizePolicy)
        self.tableTeamsTeamInfo.setMinimumSize(QtCore.QSize(300, 0))
        self.tableTeamsTeamInfo.setMaximumSize(QtCore.QSize(300, 400))
        self.tableTeamsTeamInfo.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.tableTeamsTeamInfo.setAlternatingRowColors(True)
        self.tableTeamsTeamInfo.setShowGrid(True)
        self.tableTeamsTeamInfo.setColumnCount(1)
        self.tableTeamsTeamInfo.setObjectName("tableTeamsTeamInfo")
        self.tableTeamsTeamInfo.setRowCount(10)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setVerticalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(3, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(4, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(5, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(6, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(7, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(8, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableTeamsTeamInfo.setItem(9, 0, item)
        self.tableTeamsTeamInfo.horizontalHeader().setVisible(False)
        self.tableTeamsTeamInfo.horizontalHeader().setSortIndicatorShown(False)
        self.tableTeamsTeamInfo.horizontalHeader().setStretchLastSection(True)
        self.tableTeamsTeamInfo.verticalHeader().setSortIndicatorShown(False)
        self.tableTeamsTeamInfo.verticalHeader().setStretchLastSection(False)
        self.gridLayout.addWidget(self.tableTeamsTeamInfo, 1, 1, 1, 1)
        self.label_7 = QtWidgets.QLabel(self.tabFinishedGames)
        self.label_7.setAlignment(QtCore.Qt.AlignCenter)
        self.label_7.setObjectName("label_7")
        self.gridLayout.addWidget(self.label_7, 0, 1, 1, 1)
        self.listTeamsSearchResults = QtWidgets.QListWidget(self.tabFinishedGames)
        self.listTeamsSearchResults.setMinimumSize(QtCore.QSize(600, 0))
        self.listTeamsSearchResults.setMaximumSize(QtCore.QSize(16777215, 400))
        self.listTeamsSearchResults.setObjectName("listTeamsSearchResults")
        item = QtWidgets.QListWidgetItem()
        self.listTeamsSearchResults.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listTeamsSearchResults.addItem(item)
        self.gridLayout.addWidget(self.listTeamsSearchResults, 1, 0, 1, 1)
        ...
        self.tableTeamsResults.setColumnCount(9)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.tableTeamsTeamInfo.verticalHeaderItem(0)
        item.setText(_translate("Form", "Nom"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(1)
        item.setText(_translate("Form", "Nom custom"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(2)
        item.setText(_translate("Form", "Date"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(3)
        item.setText(_translate("Form", "Score"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(4)
        item.setText(_translate("Form", "Cubes faits"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(5)
        item.setText(_translate("Form", "Durée"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(6)
        item.setText(_translate("Form", "Heure création"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(7)
        item.setText(_translate("Form", "Heure début"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(8)
        item.setText(_translate("Form", "Heure fin"))
        item = self.tableTeamsTeamInfo.verticalHeaderItem(9)
        item.setText(_translate("Form", "RFID"))
        item = self.tableTeamsTeamInfo.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Clé"))
        __sortingEnabled = self.tableTeamsTeamInfo.isSortingEnabled()
        self.tableTeamsTeamInfo.setSortingEnabled(False)
        item = self.tableTeamsTeamInfo.item(0, 0)
        item.setText(_translate("Form", "Budapest"))
        item = self.tableTeamsTeamInfo.item(1, 0)
        item.setText(_translate("Form", "Fred & Laure"))
        item = self.tableTeamsTeamInfo.item(2, 0)
        item.setText(_translate("Form", "lundi 14 mai"))
        item = self.tableTeamsTeamInfo.item(3, 0)
        item.setText(_translate("Form", "640"))
        item = self.tableTeamsTeamInfo.item(4, 0)
        item.setText(_translate("Form", "7"))
        item = self.tableTeamsTeamInfo.item(5, 0)
        item.setText(_translate("Form", "1h00"))
        item = self.tableTeamsTeamInfo.item(6, 0)
        item.setText(_translate("Form", "17:19"))
        item = self.tableTeamsTeamInfo.item(7, 0)
        item.setText(_translate("Form", "17:25"))
        item = self.tableTeamsTeamInfo.item(8, 0)
        item.setText(_translate("Form", "18:25"))
        item = self.tableTeamsTeamInfo.item(9, 0)
        item.setText(_translate("Form", "1234567890"))
        self.tableTeamsTeamInfo.setSortingEnabled(__sortingEnabled)
        self.label_7.setText(_translate("Form", "Infos de l\'équipe sélectionnée"))
        __sortingEnabled = self.listTeamsSearchResults.isSortingEnabled()
        self.listTeamsSearchResults.setSortingEnabled(False)
        item = self.listTeamsSearchResults.item(0)
        item.setText(_translate("Form", "Budapest - \"Fred & Laure\" : lundi 14 mai : 17h25 -> 18h25 : 640 points"))
        item = self.listTeamsSearchResults.item(1)
        item.setText(_translate("Form", "Stockholm - \"Afterwork Ubisoft\" : dimanche 13 mai : 19h12 -> 20h42 : 910 points"))
        self.listTeamsSearchResults.setSortingEnabled(__sortingEnabled)
        ...
        item.setText(_translate("Form", "Trophées"))
        ...
        item = self.tableTeamsResults.horizontalHeaderItem(8)
