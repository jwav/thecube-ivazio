...
CUBEBOXES_NODENAMES = tuple(f"{CUBEBOX_NODENAME_PREFIX}{i}" for i in CUBEBOX_IDS)
ALL_NODENAMES = (CUBEFRONTDESK_NODENAME, CUBEMASTER_NODENAME) + CUBEBOXES_NODENAMES
